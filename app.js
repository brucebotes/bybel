...
const goappEnv = {"GOAPP_INTERNAL_URLS":"null","GOAPP_ROOT_PREFIX":"/bybel","GOAPP_STATIC_RESOURCES_URL":"/bybel","GOAPP_VERSION":"cdccfeef3fad60e77fa4764f9928604c4d863924"};
...
function goappSetupAutoUpdate(registration) {
  const autoUpdateInterval = "691200000";
...
async function goappInitWebAssembly() {
  ...
  try {
    ...
    const wasm = await instantiateStreaming(
      fetchWithProgress("/bybel/web/app.wasm", showProgress),
      go.importObject
    );
